...
def metric_from_state(
    ...
    *,
    ...
    """Build one scenario metric from a completed graph state."""
    ...
    has_outcome = bool(state.get("final_answer") or state.get("pending_question"))
    success = actual_route == expected_route and has_outcome
